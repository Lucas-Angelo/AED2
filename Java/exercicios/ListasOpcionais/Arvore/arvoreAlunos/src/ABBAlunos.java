public class ABBAlunos {
		...
		if (raizArvore == null)
			...
			if (raizArvore.item.getNumMatricula() > alunoNovo.getNumMatricula())
				...
				if (raizArvore.item.getNumMatricula() < alunoNovo.getNumMatricula())
					...
					System.out.println("O aluno " + alunoNovo.getNome() + ", cuja matricula e "
							+ alunoNovo.getNumMatricula() + ", ja foi inserido anteriormente na arvore.");
			}
		}
		/// Retorna a raiz atualizada da árvore ou sub-árvore em que o aluno foi
		/// adicionado.
	...
	private void imprimirEmOrdem(NodoAluno raizArvore) { // Caso queira imprirmir decrescente s� trocar o .esquerda
	...
	private NodoAluno pesquisarMenor(NodoAluno raizArvore) {
	...
	public Aluno buscar(int matricula) {
		...
		NodoAluno resultado = pesquisar(raiz, matricula);
